 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LShift |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |: * / S |
 * |--------+------+------+------+------+------|Lang1 |           | LANG2|------+------+------+------+------+--------|
 * | LGui   |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  |¥ _ / C |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1| LALT | LCtrl| LALT | Right|                                       |   |  |   ¥  |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,--------------.
 *                                        | App  |ESC   |       | LEFT | RIGHT  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        // left hand
        LT(SYMB, KC_ESC),         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_DEL,
        KC_TAB,         KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   KC_ENT,
        KC_LSFT,        KC_A,         KC_S,   KC_D,   KC_F,   KC_G,
        KC_LGUI,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   KC_LANG1,
        LT(SYMB,KC_GRV),KC_LALT,      KC_LCTL,KC_LALT,KC_RGHT,
                                                    KC_APP,   KC_ESC,
                                                              KC_ENT,
                                      KC_SPC, KC_BSPC,  KC_DEL,
        // right hand
        KC_6,        KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,          JA_HAT,
        TG(SYMB),    KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             LT(SYMB, JA_AT),
                     KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,          SFT_T(JA_CLON),
        LT(SYMB, KC_LANG1),  KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,  CTL_T(JA_ENUN),
                             S(JA_ENVL),JA_ENVL,JA_LBRC,JA_RBRC,       LT(SYMB, KC_NO),
             KC_LEFT,        KC_RGHT,
             KC_UP,
             KC_DOWN,  KC_BSPC, LT(META, KC_ENT)
    ),
...
[SYMB] = KEYMAP(
       ...
       TG(META), KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, KC_TRNS,
